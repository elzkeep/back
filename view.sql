...
create view userlist_vw as select *, ifnull((select sum(b_score) from building_tb, customer_tb where b_id = cu_building and cu_user = u_id and cu_status = 1), 0) as u_totalscore from user_tb;
