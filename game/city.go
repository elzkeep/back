...
func NewCity() *City {
	...
	for i := 0; i < 3; i++ {
		...
		item.Items[2] = append(item.Items[2], resources.CityItem{Type: resources.BookCity, Name: "2 book", Receive: resources.Price{Book: resources.Book{Any: 2}, VP: 5}, Use: false})
