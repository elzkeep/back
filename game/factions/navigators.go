...
func (p *Navigators) FirstBuild(x int, y int, building Building) error {
...
func (p *Navigators) Upgrade(x int, y int, target Building, extra int) error {
	return p.Faction.Upgrade(x, y, target, extra)
}

func (p *Navigators) Downgrade(x int, y int) error {
...
func (p *Navigators) SendScholar(pos int, inc int) error {
	return p.Faction.SendScholar(pos, inc)
}

func (p *Navigators) SupployScholar(pos int, inc int) error {
...
func (p *Navigators) TurnEnd(round int, pass bool) error {
