...
func (p *Basic) FirstBuild(x int, y int) error {
...
func (p *Basic) Upgrade(x int, y int, target Building) error {
...
func (p *Basic) SendScholar() error {
	return p.Faction.SendScholar()
}

func (p *Basic) SupployScholar() error {
