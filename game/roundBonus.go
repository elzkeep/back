...
func NewRoundBonus() *RoundBonus {
	...
	items := []RoundBonusItem{
		...
		RoundBonusItem{Type: TpVP, Name: "TP >> 3", Build: resources.BuildVP{TP: 3}, Science: resources.Science{Law: 3}, Receive: resources.Price{Book: 1}},
		...
		RoundBonusItem{Type: ScienceVP, Name: "SCIENCE >> 1", Build: resources.BuildVP{Science: 1}, Science: resources.Science{Medicine: 3}, Receive: resources.Price{Book: 1}},
