...
func (p *RoundTile) Init(count int) {
	items := []TileItem{
		...
		TileItem{Category: TileRound, Type: TileRoundSpade, Name: "spd", Receive: Price{Book: 1}, Use: false},
		TileItem{Category: TileRound, Type: TileRoundBridge, Name: "bridge", Receive: Price{Book: 1}, Use: false},
		TileItem{Category: TileRound, Type: TileRoundScienceCube, Name: "1 science", Receive: Price{Worker: 2}, Use: false},
