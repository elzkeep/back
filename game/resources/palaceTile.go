...
func (p *PalaceTile) Init(count int) {
	items := []TileItem{
		...
		TileItem{Category: TilePalace, Type: TilePalaceScience, Name: "1 bridge", Receive: Price{Book: Book{Any: 1}, Power: 2}, Action: Price{Science: Science{Single: 2}}, Use: false},
		...
		TileItem{Category: TilePalace, Type: TilePalacePower, Name: "4 power", Receive: Price{Coin: 6}, Once: Price{Book: Book{Any: 2}, Power: 12}, Use: false},
		...
		TileItem{Category: TilePalace, Type: TilePalaceTpVp, Name: "6 coin", Action: Price{Coin: 3, Book: Book{Any: 1}}, Build: BuildVP{TP: 3}, Use: false},
		TileItem{Category: TilePalace, Type: TilePalaceRiverCity, Name: "6 coin", Receive: Price{Power: 6, ShipUpgrade: 2}, Use: false},
		TileItem{Category: TilePalace, Type: TilePalaceBridge, Name: "6 coin", Receive: Price{Power: 6}, Once: Price{Book: Book{Any: 2}, Spade: 2, Bridge: 2}, Use: false},
		TileItem{Category: TilePalace, Type: TilePalaceTpBuild, Name: "tp build", Receive: Price{Power: 2, Book: Book{Any: 1}}, Once: Price{Building: TP}, Use: false},
	}
