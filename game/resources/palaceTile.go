...
func (p *PalaceTile) Init(count int) {
	items := []TileItem{
		...
		TileItem{Category: TilePalace, Type: TilePalaceDVp, Name: "6 coin", Receive: Price{Power: 8}, Use: false},
		TileItem{Category: TilePalace, Type: TilePalaceTpVp, Name: "6 coin", Action: Price{Coin: 3, Book: 1}, Use: false},
		TileItem{Category: TilePalace, Type: TilePalaceRiverCity, Name: "6 coin", Receive: Price{Power: 6}, Use: false},
