...
func (c *GameundoitemController) FindByGame(game int64) []models.Gameundoitem {
...
func (c *GameundoitemController) CountByGame(game int64) int {
...
// @Delete()
func (c *GameundoitemController) DeleteByGame(game int64) {
