...
func (c *StatisticsController) Read(id int64) {
    
    
	conn := c.NewConnection()

	manager := models.NewStatisticsManager(conn)
	item := manager.Get(id)
...
func (c *StatisticsController) Index(page int, pagesize int) {
...
func (c *StatisticsController) Sum() {
